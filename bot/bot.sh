...
# Develovers » CX Official Store࿐
# Email      » CX@gmail.com
# telegram   » https://t.me/CX
...
cd /usr/bin
wget https://raw.githubusercontent.com/robbyhalintar2/cxz/main/bot/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
clear
wget https://raw.githubusercontent.com/robbyhalintar2/cxz/main/bot/kyt.zip
unzip kyt.zip
